...
/* https://github.com/rfranco84/Vector2D */
...
public:
    ...
    // Prend le rect et renvoie un vecteur positionné au centre du rect
    Vector2 RectToVector(SDL_Rect rect); 

    // Traduit la position du rect en fonction de la position du vecteur (ex : rect.x = vector2.x - rect.w/2)
    SDL_Rect VectorToRect(SDL_Rect rect); 
